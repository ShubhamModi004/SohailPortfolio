        ...
        <div className="hero">
            ...
            <div className="container heroSection">
                <div>
                    ...
                    <Fade delay={150}><h4 className="tagline" style={{ marginTop: '1.8rem' }}>A Digital Designer from Bangalore, India.</h4></Fade>
                    <Fade delay={150}><h4 className="tagline">Specialized in User Interface & User Experience Design</h4></Fade>
