        ...
        <div className="hero">
            ...
            <div className="container heroSection">
                <div>
                    ...
                    <Fade delay={150}><h4 className="tagline" style={{ marginTop: '1.8rem' }}>"I strive for two things in design: simplicity and clarity.</h4></Fade>
                    <Fade delay={150}><h4 className="tagline">Great design is born of those two things."</h4></Fade>
                </div>
            </div>
        </div>
    )
